...
const Login = () => {
  ...
  return (
    <div className="flex justify-between items-center h-24 max-w-[1240px] mx-auto px-2 text-black">
      <div className="w-28 bg-blue-300">
        ...
        <form 
        className="whitespace-pre-wrap absolute top-[220px] left-[554px] w-[432px] h-[386px] border border-blue-400  shadow-md
  ...
  <fieldset style={{ textAlign: "center" }}>
            ...
            <br></br>
            <br></br>
            <p className="font-bold  text-[#00AFFA] text-3xl">Login</p>
            <br></br>
        ...
        <label >
          Password :&nbsp;&nbsp;
          <input type="password" value={password} onChange={handlePasswordChange} style={{ backgroundColor: '#D9D9D9' , boxShadow: "0px 1px 0px #00AFFA" }} />
        </label>
        <br></br>            <br></br>

        <p className="text-xs text-[#00AFFA] ">Forgot Password</p>
        <br></br>
        <button type="login" style={{ backgroundColor: '#00AFFA' }}>    Log In    </button>
        <br></br>
